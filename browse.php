...
<body>
    ...
    <div id="itemBrowser">
        ...
        <article itemid="0" onclick="viewItem(this)">
            <img src="img/items/item0.png" alt="An image of item with id 0">
            <h1>Example name</h1>
        ...
        <article itemid="0" onclick="viewItem(this)">
            <img src="img/items/item1.png" alt="An image of item with id 0">
            <h1>Example name</h1>
            <h2>Collection name</h2>
            <h3>$320</h3>
            <button>Purchase</button>
